...
public class Trader<T> {
    ...
    public void addToWishlist(T new_obj) {
        this.wishlist.add(new_obj);
    }
    ...
    public int getSellingPrice(T this_obj) {
        if (this_obj instanceof Tradable) return ((Tradable) this_obj).getPrice();
